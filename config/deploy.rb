...
role :web, "workflow.com"                          # Your HTTP server, Apache/etc
role :app, "workflow.com"                         # This may be the same as your `Web` server
role :db,  "workflow.com"   , :primary => true # This is where Rails migrations will run
